...
## Project Structure
    ...
    ├── module_options_test_29703  # Django project configurations
...
1. Clone this repo and `cd module_options_test_29703`
...
2. Clone this repo and `cd module_options_test_29703`
